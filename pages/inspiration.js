...
export default function Inspiration({ products }) {
  const boxSX = {
    "&:hover": {
  ...
  return (
    ...
    <>
    {/* <div> */}
    <Typography variant ='h1' sx={{textalign:'center'}} gutterBottom>Inspiration</Typography>
...
Inspiration.getLayout = function pageLayout(page) {
    return (
      <>
        {page}
        <Footer />
